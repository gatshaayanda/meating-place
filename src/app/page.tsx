...
export default function Home() {
  return <main className="site meatingSite">
    ...
    <nav className="nav meatNav"><div className="container navInner"><Link href="/" className="meatLogo">THE MEATING PLACE<span>CAR WASH &amp; BRAAI</span></Link><div className="navLinks"><a href="#food">Food</a><a href="#wash">Car Wash</a><a href="#braai">Braai</a><a href="#visit">Find Us</a></div><Link href="/book" className="button meatButton">Make a booking</Link></div></nav>

    <section className="meatHero"><div className="meatHeroImage"><img src={asset(photos[6])} alt="The Meating Place" /></div><div className="meatHeroOverlay" /><div className="container meatHeroContent"><span className="meatStamp">LET&apos;S MEAT &amp; EAT</span><h1>Pull up.<br /><em>We&apos;ll sort the rest.</em></h1><p>Get the car looking right. Get something good on the grill. Stay for the vibe.</p><div className="heroChoices"><Link href="/book?type=car-wash" className="heroChoice heroChoiceWash"><span>🚗</span><strong>Wash my car</strong><small>Book the wash</small></Link><Link href="/book?type=food" className="heroChoice heroChoiceFood"><span>🔥</span><strong>Feed me</strong><small>Food &amp; braai</small></Link></div></div></section>
